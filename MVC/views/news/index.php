            ...
            <div id="page-bgbtm">
                <div id="content">
                    <?php foreach ($newsList as $newsItem): ?>
                        <div class="post">
                            <h2 class="title"><a href='/news/<?= $newsItem['id'] ;?>'><?= $newsItem['title'].' # '.$newsItem['id'];?></a></h2>
                            <p class="meta">Posted by <a href="#"><?= $newsItem['author_name'];?></a> on <?= $newsItem['date'];?>
                                &nbsp;&bull;&nbsp; <a href='/news/<?= $newsItem['id'] ;?>' class="permalink"> Full article</a></p>
                            <div class="entry">
                                <p><img src="../../template<?= $newsItem['preview'];?>" alt="" /></p>
