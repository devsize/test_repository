...
// путь к файлу данных для навигации
define('NAVIGATION_SOURCE_PATH'                     , './page_source/navigation.json');
// путь к файлу шаблона навигации
define('NAVIGATION_TEMPLATE_PATH'               , './templates/header/navigation.html');
// путь к файлу линков для шаблона навигации
define('NAVIGATION_TEMPLATE_LINKS_PATH'               , './templates/header/links.html');
...
define('ID', '785687188490347');
define('SECRET', 'c7cd9d7ff01d70323f2f527affa03558');
//define('URL', 'http://localhost/MyPHP/facebook/index.php');
define('URL', 'http://localhost/MyPHP/Lesson-12-HTML-Release/action.php');
